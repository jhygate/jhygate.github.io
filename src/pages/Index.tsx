  ...
  const projects = [
    {
      ...
      githubUrl: "https://github.com/jhygate/loop-pad",
      projectUrl: "https://jackhygate.co.uk/looppad/",
    },
    {
      name: "Guitar Chord Explorer",
      description: "Interactive tool for exploring guitar chords, scales, and music theory.",
      bullets: [
        "Visual fretboard and piano keyboard for exploring chord shapes and voicings.",
        "Chord identification and music theory integration.",
        "Built with Angular and VexFlow for sheet music rendering.",
      ],
      techStack: ["TypeScript", "Angular", "VexFlow", "Music Theory"],
      githubUrl: "https://github.com/jhygate/guitair-chord-explorer",
      projectUrl: "https://jackhygate.co.uk/guitar-chords/",
    },
  ];
